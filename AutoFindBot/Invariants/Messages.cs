...
public class Messages
{
    ...
    public const string UserConfirmation = "Регистрация успешно подтверждена.\n" +
                                           "Теперь я буду вам присылать новые объявления.\n" +
                                           "Да прибудет с вами сила и удача в поисках автомобиля вашей мечты.";
